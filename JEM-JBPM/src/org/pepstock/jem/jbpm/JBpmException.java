...
public class JBpmException extends MessageException {
	 ...
	 */
	public JBpmException(MessageInterface messageInterface) {
	 ...
	 */
	public JBpmException(MessageInterface messageInterface, Object... objects) {
	 ...
	 * @param objects data to fill message
	 */
	public JBpmException(MessageInterface messageInterface, Throwable cause, Object... objects) {
