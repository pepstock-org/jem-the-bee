...
public enum JBpmMessage implements MessageInterface{
	...
	JEMM001E("0001", "Mandatory variable \"{0}\" is missing", MessageLevel.ERROR), 
	...
	JEMM002E("0002", "Current Task with ID \"{0}\" not found", MessageLevel.ERROR), 
	...
	JEMM003E("0003", "Unable to create a data description implementation", MessageLevel.ERROR),
	...
	JEMM004E("0004", "WorkiItem class \"{0}\" is not an instance of JemWorkItem", MessageLevel.ERROR),
	...
	JEMM005E("0005", "Data description doesn't have 'name' attribute", MessageLevel.ERROR),
	...
	JEMM006E("0006", "Unable to load work item class \"{0}\"", MessageLevel.ERROR),
	...
	JEMM007E("0007", "Output path is null", MessageLevel.ERROR),
	...
	JEMM008E("0008", "Data description \"{0}\", disposition \"{1}\" : Disposition wrong with a multi: only SHR is allowed", MessageLevel.ERROR),	
	...
	@Description(explanation = "It occurs when you try to access to data description reference without using SHR disposition which is mandatory."+
	 "<br>Check data description definition.")
	JEMM009E("0009", "Data description \"{0}\", disposition \"{1}\", \"{2}\" : Disposition wrong with a reference: only SHR is allowed", MessageLevel.ERROR),	
	...
	JEMM010E("0010", "Data description \"{0}\", \"{1}\" : Dataset doesn't exist", MessageLevel.ERROR),
	...
	@Description(explanation = "It occurs when you try to access to file which is not found."+
	 "<br>Check data description definition or file system.")
	JEMM011E("0011", "Data description \"{0}\", disposition \"{1}\", \"{2}\" : File not found", MessageLevel.ERROR),	
	...
	@Description(explanation = "It occurs when you try to access to a reference but dataset is not a reference."+
	 "<br>Check data description definition.")
	JEMM012E("0012", "Data description \"{0}\", disposition \"{1}\", \"{2}\" : Dataset is not a reference", MessageLevel.ERROR),
	...
	@Description(explanation = "It occurs when you try to access to temporary dataset without using NEW disposition which is mandatory."+
	 "<br>Check data description definition.")
	JEMM013E("0013", "Data description \"{0}\", disposition \"{1}\", \"{2}\" : Disposition wrong with a temporary file: only NEW is allowed", MessageLevel.ERROR),	
	...
	@Description(explanation = "It occurs when you try to define a data set without <code>name</code> attribute."+
	 "<br>Check data description definition.")
	JEMM014E("0014", "Data description \"{0}\", disposition \"{1}\" : Dataset doesn't have 'name' attribute", MessageLevel.ERROR),
	...
	JEMM015E("0015", "Data description \"{0}\", disposition \"{1}\", \"{2}\" : Dataset already exists", MessageLevel.ERROR),	
	...
	JEMM016E("0016", "Data description name \"{0}\" is not a OutputStream instance but \"{1}\"", MessageLevel.ERROR),
	...
	@Description(explanation = "It occurs when you try to define a data set using data source attribute which is empty even if defined."+
	 "<br>Check data description definition.")
	JEMM020E("0020", "Data source value is empty", MessageLevel.ERROR),
	...
	JEMM021E("0021", "Data source name attribute is empty", MessageLevel.ERROR),
	...
	@Description(explanation = "It occurs when you try to define a data source but the resource attribute is empty even if defined."+
	 "<br>Check data source definition.")
	JEMM022E("0022", "Data source resource attribute is empty", MessageLevel.ERROR),
	...
	JEMM026E("0026", "List of current tasks is null", MessageLevel.ERROR),
	...
	JEMM027E("0027", "Data source is not well defined: 'resource' is null", MessageLevel.ERROR),
	...
	JEMM028E("0028", "Access to \"{0}\" is not allowed", MessageLevel.ERROR),
	...
	JEMM029E("0029", "An exception [\"{0}\"] happened in process instance [\"{1}\"] of process [\"{2}\"] in node [id: \"{3}\", name: \"{4}\"]", MessageLevel.ERROR),
	...
	JEMM030E("0030", "Resorce \"{0}\" with type \"{1}\" is not supported", MessageLevel.ERROR),
	...
	JEMM031E("0031", "Job name is null", MessageLevel.ERROR),
	...
	JEMM032E("0032", "Property \"{0}\" must be "+JBpmKeys.JBPM_JOB_SCOPE+", "+JBpmKeys.JBPM_STEP_SCOPE+" or "+JBpmKeys.JBPM_TASK_SCOPE+", instead of \"{1}\"", MessageLevel.ERROR),
	
	/**
	 * "Job name is null", MessageLevel.ERROR
	 */
	@Description(explanation = "It informs what kind of locking scope the job is using.")
	JEMM033I("0033", "Job is using \"{0}\" locking scope.", MessageLevel.INFO),
	
	/**
	 * "Data description reference: \"{0}\"", MessageLevel.INFO
	 */
	@Description(explanation = "It informs what data description is currently used.")
	JEMM034I("0034", "Data description instance: \"{0}\"", MessageLevel.INFO),
	
	/**
	 * "Data source reference: \"{0}\"", MessageLevel.INFO
	 */
	@Description(explanation = "It informs what data source is currently used.")
	JEMM035I("0035", "Data source instance: \"{0}\"", MessageLevel.INFO),
	...
	JEMM036E("0036", "Unable to complete storing GDG : {0}", MessageLevel.ERROR),
	...
	JEMM037E("0037", "Unable to unbind resources from JNDI: {0}", MessageLevel.ERROR),
	...
	JEMM038E("0038", "RMI object {0} is not binded", MessageLevel.ERROR),
	...
	JEMM039E("0039", "Security Manager already instantiated.", MessageLevel.ERROR),
	...
	JEMM040E("0040", "Error while starting job {0}", MessageLevel.ERROR),
	...
	@Description(explanation = "It occurs when you try to define a dataset but the name attribute is empty even if defined."+
	 "<br>Check lock definition.")
	JEMM041E("0041", "Dataset name attribute is empty", MessageLevel.ERROR),
	...
	JEMM042I("0042", "Sort is using the following comparator class: {0}", MessageLevel.INFO),
	...
	JEMM043I("0043", "Sort is using default comparator class", MessageLevel.INFO),
	...
	JEMM044W("0044", "Unable to load sort statements from COMMAND data description: {0}", MessageLevel.WARNING),
	...
	JEMM045I("0045", "Sort statements from COMMAND data description: {0}", MessageLevel.INFO),
	...
	JEMM046W("0046", "Syntax error parsing sort statement \"{0}\": {1}", MessageLevel.WARNING),
	...
	JEMM047E("0047", "JCL Validation error, look:\"{0}\"", MessageLevel.ERROR),
	...
	JEMM048E("0048", "Not possible to know if the work-item \"{0}\" is completed", MessageLevel.ERROR),
	...
	JEMM049E("0049", "Invalid arguments are passed to launcher", MessageLevel.ERROR),
	...
	JEMM050E("0050", "Disposition is missing for data description \"{0}\"", MessageLevel.ERROR),
	...
	JEMM051E("0051", "SYSOUT has been specified with a dataset for data description \"{0}\". Not allowed", MessageLevel.ERROR),
	...
	JEMM052E("0052", "More than 1 dataset has been specified with DATASOURCE key word for data description \"{0}\". Not allowed", MessageLevel.ERROR),
	...
	JEMM053E("0053", "Dataset name and content are null for data description \"{0}\"", MessageLevel.ERROR),
	...
	JEMM054E("0054", "PROPERTIES syntax error for data source \"{0}\"", MessageLevel.ERROR),
	...
	JEMM056E("0056", "Invalid class name: {0} ", MessageLevel.ERROR),
	...
	JEMM057I("0057", "Task \"{0}\" is ended with return code {1}", MessageLevel.INFO),
	...
	JEMM058W("0058", "Unable to parse sort statements from COMMAND data description.", MessageLevel.WARNING),
	...
	JEMM059E("0059", "Unable to create internal lock manager.", MessageLevel.ERROR),
	...
	JEMM060E("0060", "Unable to get lock for resources.", MessageLevel.ERROR),
	...
	JEMM061E("0061", "Unable to unlock resources.", MessageLevel.ERROR),
	...
	JEMM062I("0062", "\"{0}\" bytes have been written", MessageLevel.INFO),
	...
	JEMM063E("0063", "Unable to get process", MessageLevel.ERROR);
	 ...
	 * @see Message
	 */
	private JBpmMessage(String code, String messageContent, MessageLevel level){
