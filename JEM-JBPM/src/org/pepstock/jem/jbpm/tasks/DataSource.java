...
public class DataSource implements Serializable {
	...
	public void setName(String name) {
		...
		if (name.trim().length() == 0){
			throw new JemRuntimeException(JBpmMessage.JEMM021E.toMessage().getFormattedMessage());
		}
		this.name = name;
	}
	...
	public void setResource(String resource) {
		...
		if (resource.trim().length() == 0){
			throw new JemRuntimeException(JBpmMessage.JEMM022E.toMessage().getFormattedMessage());
		}
