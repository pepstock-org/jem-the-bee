 ...
 * 
 */
public class SurrogatePermissionsPanel extends ListPermissionsPanel {
	 ...
	 * 
	 */
	public SurrogatePermissionsPanel(Role role) {
		super(role, Permissions.SURROGATE, "Surrogate user pattern",  new PermissionCell(Images.INSTANCE.permission()));
	}
