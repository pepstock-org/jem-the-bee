...
public final class NetworkEditConfig extends HorizontalPanel implements InspectListener<String>, ClickHandler, ResizeCapable {
	 ...
	 * 
	 */
	public NetworkEditConfig(List<String> addresses) {
		...
		cellList.setRowCount(addresses.size(), true);
		cellList.setRowData(0, addresses);
	...
	public void remove(String selected){
		if (selected != null){
			...
			cellList.setRowCount(addresses.size());
			cellList.setRowData(0, addresses);
		}
