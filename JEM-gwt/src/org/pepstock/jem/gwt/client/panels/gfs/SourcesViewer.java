 ...
 *
 */
public class SourcesViewer extends FileSystemPanel {
	
	private SourcesFilesTable table = null;

	/**
	 * 
	 */
	public SourcesViewer() {
		super(PreferencesKeys.EXPLORER_SEARCH_SOURCES);
	}
    ...
    static class SourcesFilesTable extends FilesTable{
        ...
        public IndexedColumnComparator<GfsFile> getIndexedColumnComparator() {
	        return new FilesComparator(0, PreferencesKeys.EXPLORER_SORT_SOURCES);
        }
