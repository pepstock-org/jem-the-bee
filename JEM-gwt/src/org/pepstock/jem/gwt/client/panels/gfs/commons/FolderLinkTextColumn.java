 ...
 */
public abstract class FolderLinkTextColumn extends Column<GfsFile, GfsFile> {

	private static SafeHtmlRenderer anchorRenderer = new SafeHtmlRenderer();
	
	private static class SafeHtmlRenderer extends AbstractSafeHtmlRenderer<GfsFile> {
		@Override
