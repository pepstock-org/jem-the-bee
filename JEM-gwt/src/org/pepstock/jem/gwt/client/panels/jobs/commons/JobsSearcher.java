 ...
 *
 */
public class JobsSearcher extends SearcherFilterableListenerWidget {

	/**
	 * Construct the panel, with label for text field
	 * 
	 * @param preferenceKey for history
	 */
	public JobsSearcher(String preferenceKey) {
		super("Jobs: ", -1, "", preferenceKey);
	}
}