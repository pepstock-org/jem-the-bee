...
import org.pepstock.jem.gwt.client.panels.resources.ResourceTypeChooser;
 ...
 *
 */
public final class ChooserActions extends VerticalPanel {
	
	static {
		Styles.INSTANCE.common().ensureInjected();
	}
	
	private ResourceTypeChooser inspector = null;
	...
	public ChooserActions() {
		...
		okButton.addStyleName(Styles.INSTANCE.common().defaultActionButton());
		subsomponent.add(okButton);
	 ...
	 */
	public ResourceTypeChooser getInspector() {
		return inspector;
	}
	 ...
	 */
	public void setInspector(ResourceTypeChooser inspector) {
