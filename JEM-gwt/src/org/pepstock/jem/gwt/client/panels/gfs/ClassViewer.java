 ...
 *
 */
public class ClassViewer extends FileSystemPanel{
	
	private ClassFilesTable table = null;

	/**
	 * 
	 */
	public ClassViewer() {
		super(PreferencesKeys.EXPLORER_SEARCH_CLASS);
	}
    ...
    static class ClassFilesTable extends FilesTable{
        ...
        public IndexedColumnComparator<GfsFile> getIndexedColumnComparator() {
	        return new FilesComparator(0, PreferencesKeys.EXPLORER_SORT_CLASS);
        }
    }
