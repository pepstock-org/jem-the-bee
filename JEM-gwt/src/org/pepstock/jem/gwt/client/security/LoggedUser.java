...
import org.pepstock.jem.gwt.server.rest.map.UserPreferencesMapAdapter;
...
public class LoggedUser extends Subject {
	...
	public String toString() {
		return "Id=" + getId() + "; OrgUnit=" + (getOrganizationalUnit() != null ? getOrganizationalUnit().getId() : JemConstants.NONE_BRACKETS) + "; FullName=" + getName(); 
	}
}