 ...
 */
package org.pepstock.jem.junit.test.rest.java;
...
public class DeleteJunitDataSet {
	...
	/**
	 * name of the dataset that will contain the data of the rest test
	 */
	private static final String DATA_SET_JUNIT_FOLDER = "test_rest";
