...
*/
package org.pepstock.jem.junit.test.common;
 ...
 * @version 1.4
 */
public class CreateJemJdbcDataSource extends TestCase{
	 ...
	 * @throws Exception
	 */
	public void testCreateJemJdbcDataSource() throws Exception {
		Future<SubmitResult> future = JemTestManager.getSharedInstance()
				.submit(getJcl("TEST_COMMON_CREATE_JEM_JDBC_DATA_SOURCE.xml"), "ant", true,
						false);
