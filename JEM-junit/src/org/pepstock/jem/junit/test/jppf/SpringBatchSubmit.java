...
public class SpringBatchSubmit extends TestCase{
	...
	public void testSpringBatchDatasource() throws Exception {
		Future<SubmitResult>future = JemTestManager.getSharedInstance()
				.submit(getJcl("springbatch/TEST_JPPF_SB_Datasource.xml"), SpringBatchFactory.SPRINGBATCH_TYPE, true,
						false);
	...
	public void testSpringBatchSimple() throws Exception {
		Future<SubmitResult>future = JemTestManager.getSharedInstance()
				.submit(getJcl("springbatch/TEST_JPPF_SB_Simple.xml"), SpringBatchFactory.SPRINGBATCH_TYPE, true,
						false);
		SubmitResult sr = future.get();
		assertEquals(sr.getRc(), 0);
	}
	...
	public void testSpringBatchReader() throws Exception {
		Future<SubmitResult>future = JemTestManager.getSharedInstance()
				.submit(getJcl("springbatch/TEST_JPPF_SB_Reader.xml"), SpringBatchFactory.SPRINGBATCH_TYPE, true,
						false);
		SubmitResult sr = future.get();
		assertEquals(sr.getRc(), 0);
	}
	...
	public void testSpringBatchWriter() throws Exception {
		Future<SubmitResult>future = JemTestManager.getSharedInstance()
				.submit(getJcl("springbatch/TEST_JPPF_SB_Writer.xml"), SpringBatchFactory.SPRINGBATCH_TYPE, true,
						false);
		SubmitResult sr = future.get();
		assertEquals(sr.getRc(), 0);
	}
	...
	public void testSpringBatchReaderWriter() throws Exception {
		Future<SubmitResult>future = JemTestManager.getSharedInstance()
				.submit(getJcl("springbatch/TEST_JPPF_SB_ReaderWriter.xml"), SpringBatchFactory.SPRINGBATCH_TYPE, true,
						false);
		SubmitResult sr = future.get();
		assertEquals(sr.getRc(), 0);
	}
