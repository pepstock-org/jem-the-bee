...
/**
 * Simple runnable used to JPPF test 
 * @author Andrea "Stock" Stocchero
 *
 */
public class RunnableDatasource implements Runnable, Serializable {
	...
	public void run() {
		try {
			...
			Object o = (Object) ic.lookup("JUNIT_JPPF_JDBC_JEM");
			System.err.println(task.getIndex()+" datasource: "+o.toString());
		} catch (Exception e) {
