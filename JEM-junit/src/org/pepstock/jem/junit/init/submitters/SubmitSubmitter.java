 ...
 * @version 2.2
 */
public class SubmitSubmitter extends AbstractSubmitter {
	 ...
	 * @param printout
	 */
	public SubmitSubmitter(Submitter selectedSubmitter, String jcl, String type, boolean wait, boolean printout) {
