 ...
 * @version 2.2
 */
public class LocalHostSubmitter extends AbstractSubmitter {
	 ...
	 * @param printout
	 */
	public LocalHostSubmitter(Submitter selectedSubmitter, String jcl, String type, boolean wait, boolean printout) {
	...
	public SubmitResult call() throws Exception {
		...
		if (getSelectedSubmitter().getEmbedded()){
			...
			int rc =  launch("jem_localhost_submit", args);
