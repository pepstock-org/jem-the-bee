...
public enum NotifyMessage implements MessageInterface{	
	...
	JEMN001E("0001", "Wrong email address \"{0}\".", MessageLevel.ERROR),
	...
	JEMN002E("0002", "No email address found: all mail addresses are wrong.", MessageLevel.ERROR),
	...
	JEMN003E("0003", "No email address found as destination of the email.", MessageLevel.ERROR),
	...
	JEMN004E("0004", "Error creating email text with text template: [{0}].", MessageLevel.ERROR),
	...
	JEMN005E("0005", "Error creating email subject with subject template: [{0}].", MessageLevel.ERROR),
	...
	JEMN006E("0006", "Wrong email template file directory: \"{0}\".", MessageLevel.ERROR),
	...
	JEMN007W("0007", "Configuration email template file \"{0}\" does not exist. Create new email template file \"{0}\" inside directory: \"{1}\".", MessageLevel.WARNING),
	...
	JEMN008E("0008", "Error loading EmailTemplate.", MessageLevel.ERROR),
	...
	JEMN009E("0009", "Error starting automatic control for email template file changes. The template file is: \"{0}\".", MessageLevel.ERROR),
	...
	JEMN010E("0010", "Error reading email template file \"{0}\".", MessageLevel.ERROR),
	...
	JEMN011W("0011", "The email template xml file \"{0}\" has been deleated, using previous EmailTemplate. Create new email template file \"{0}\" inside directory: {1}.", MessageLevel.WARNING),
	...
	JEMN012E("0012", "{0} not configured. It must have a value.", MessageLevel.ERROR),
	...
	JEMN013E("0013", "{0} is null.", MessageLevel.ERROR),
	...
	JEMN014W("0014", "The email has no {0}.", MessageLevel.WARNING),
	...
	JEMN016E("0016", "Problems sending email: {0} \n.", MessageLevel.ERROR),
	...
	JEMN017I("0017", "{0}", MessageLevel.INFO),
	...
	JEMN018W("0018", "The Jcl of the Job has no notification email addresses", MessageLevel.WARNING);
	 ...
	 * @see Message
	 */
	private NotifyMessage(String code, String messageContent, MessageLevel level){
