...
import org.pepstock.jem.notify.engine.SmsNotifier;


/**
 * A <code>SendSmsException</code> is thrown by the {@link SmsNotifier}
 * class in the method {@link SmsNotifier#doNotify(org.pepstock.jem.notify.NotifyObject) doSmsNotify}
 * to indicate a problem sending Sms. <br>
 * It extends {@link NotifyException}.
 * 
 * @author Alessandro Zambrini
 * @version 1.0	
 */
public class SendSmsException extends NotifyException{
	 ...
	 */
	public SendSmsException(Exception exception){
		super(exception);
	}
	 ...
	 * @param exception the cause of this exception.
	 */
	public SendSmsException(String message, Exception exception){
