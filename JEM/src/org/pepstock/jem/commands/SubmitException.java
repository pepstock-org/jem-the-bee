...
/**
 * Exception creates when some errors occur during job submit
 * 
 * @author Andrea "Stock" Stocchero
 * @version 1.4
 */
public class SubmitException extends MessageException {
	 ...
	 */
	public SubmitException(MessageInterface messageInterface) {
	 ...
	 */
	public SubmitException(MessageInterface messageInterface, Object... objects) {
	 ...
	 * @param objects data to fill message
	 */
	public SubmitException(MessageInterface messageInterface, Throwable cause, Object... objects) {
