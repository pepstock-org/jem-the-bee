...
import org.pepstock.jem.protocol.ClientConfig;
 ...
 * 
 */
public class NewLocalHostSubmit extends AbstractNewConnectedClusterSubmit {
	 ...
	 */
	@Override
	public Client createClient() throws SubmitException {
//		getPrivateKey(), 
//		getPrivateKeyPassword(), 
		try {
			ClientConfig config = new ClientConfig();
			config.setGroup(getEnvironment());
...
//					config.addAddresses(addr.getHostAddress() + ":" + getPort());
//				}
//			}
...
//			throw new SubmitException(SubmitMessage.JEMW005E, e);
	...
	public static void main(String[] args) {
		Times.start();
		NewLocalHostSubmit submit = new NewLocalHostSubmit();
