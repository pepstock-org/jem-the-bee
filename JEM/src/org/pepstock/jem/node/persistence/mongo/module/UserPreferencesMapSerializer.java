...
/**
 * Jackson module to serialize UserPreferences MAP instance.
 ...
 * @version 3.0
 */
class UserPreferencesMapSerializer extends JsonSerializer<UserPreferencesMap> {
	
	/* (non-Javadoc)
	 * @see org.codehaus.jackson.map.JsonSerializer#serialize(java.lang.Object, org.codehaus.jackson.JsonGenerator, org.codehaus.jackson.map.SerializerProvider)
	 */
	@Override
	public void serialize(UserPreferencesMap object, JsonGenerator generator, SerializerProvider provider) throws IOException, JsonProcessingException {
		// starts write object
		generator.writeStartObject();
		// scans all properties
		for (Entry<String, UserPreference> entry : object.entrySet()){
