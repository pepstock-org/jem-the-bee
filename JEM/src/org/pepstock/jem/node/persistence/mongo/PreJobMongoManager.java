 ...
 * @version 3.0
 */
public class PreJobMongoManager extends AbstractMongoManager<PreJob> implements Recoverable {
	 ...
	 */
	@Override
	public PreJob createObject(ObjectMapper mapper, String objFound) throws IOException {
		return mapper.readValue(objFound, PreJob.class);
	}
