 ...
 * @version 3.0
 */
class ResourceLockMapDeserializer extends JsonDeserializer<ResourceLockMap> {

	/* (non-Javadoc)
	 * @see org.codehaus.jackson.map.JsonDeserializer#deserialize(org.codehaus.jackson.JsonParser, org.codehaus.jackson.map.DeserializationContext)
	 */
	@Override
	public ResourceLockMap deserialize(JsonParser parser, DeserializationContext deser) throws IOException, JsonProcessingException {
		// gets codec
		...
		// creates the object
		ResourceLockMap properties = new ResourceLockMap();
		// reads element
		...
		while(iter.hasNext()){
			...
			// reads the locks
			ResourceLock property = codec.readValue(jp, ResourceLock.class);
