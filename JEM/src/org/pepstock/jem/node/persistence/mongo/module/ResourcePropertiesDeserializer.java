 ...
 * @version 3.0
 */
class ResourcePropertiesDeserializer extends JsonDeserializer<ResourceProperties> {

	/* (non-Javadoc)
	 * @see org.codehaus.jackson.map.JsonDeserializer#deserialize(org.codehaus.jackson.JsonParser, org.codehaus.jackson.map.DeserializationContext)
	 */
	@Override
	public ResourceProperties deserialize(JsonParser parser, DeserializationContext deser) throws IOException, JsonProcessingException {
		// gets codec
		...
		while(iter.hasNext()){
			...
			// reads the resource properties
			ResourceProperty property = codec.readValue(jp, ResourceProperty.class);
