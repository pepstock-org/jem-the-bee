...
public class Permissions {
	 ...
	 */
	public static final String FILES_STAR = FILES + PERMISSION_SEPARATOR + ALL_BY_REGEX;
	 ...
	 * Permission tag for ALL role actions
	 */
	public static final String ADMINISTRATION_CLUSTER_MEMORY_USAGE = ADMINISTRATION_CLUSTER + PERMISSION_SEPARATOR + "memory-usage";
	...
	public static final String[] ADMINISTRATION_ALL = { ADMINISTRATION_CLUSTER_GRS, ADMINISTRATION_CLUSTER_REDO, ADMINISTRATION_SECURITY_SECRET, ADMINISTRATION_SECURITY_CERTIFICATE, ADMINISTRATION_CLUSTER_WORKLOAD, ADMINISTRATION_CLUSTER_GFS_USAGE,
			ADMINISTRATION_CLUSTER_MEMORY_USAGE, ADMINISTRATION_CLUSTER_CONFIGURATION, ADMINISTRATION_NODES_COMMANDS, ADMINISTRATION_NODES_CONFIGURATION, ADMINISTRATION_NODES_QUEUES, ADMINISTRATION_NODES_SYSTEM, ADMINISTRATION_QUEUES_CURRENT,
	...
	private static final String[] EQUALS_TO_CHECK = new String[] { STAR, INTERNAL_SERVICES, RESOURCES_STAR, RESOURCES_CREATE, RESOURCES_DELETE, RESOURCES_UPDATE, RESOURCES_READ, FILES_STAR, NODES_STAR, NODES_DRAIN, NODES_START, NODES_UPDATE, VIEW_STAR,
	...
	private static final String[] STARTSWITH_TO_CHECK = new String[] { FILES_READ, FILES_WRITE, FILES_EXECUTE, DATASOURCES + PERMISSION_SEPARATOR, SURROGATE + PERMISSION_SEPARATOR, SEARCH_JOBS, SEARCH_NODES, ADMINISTRATION_CLUSTER_STAR,
			ADMINISTRATION_CLUSTER_GRS, ADMINISTRATION_CLUSTER_REDO, ADMINISTRATION_SECURITY_CERTIFICATE, ADMINISTRATION_SECURITY_SECRET, ADMINISTRATION_CLUSTER_WORKLOAD, ADMINISTRATION_CLUSTER_GFS_USAGE, ADMINISTRATION_CLUSTER_MEMORY_USAGE,
