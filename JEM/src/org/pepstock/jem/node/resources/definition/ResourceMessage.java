...
public enum ResourceMessage implements MessageInterface{
	...
	JEMR001E("0001", "The resource template location is missing.", MessageLevel.ERROR),
	...
	JEMR002E("0002", "Configuration resource template location \"{0}\" does not exist.", MessageLevel.ERROR),
	...
	JEMR003E("0003", "Error loading ResourceTemplate.", MessageLevel.ERROR),
	...
	JEMR004E("0004", "Type of resource is null", MessageLevel.ERROR),
	...
	JEMR005E("0005", "Error reading resource template \"{0}\".", MessageLevel.ERROR),
	...
	JEMR006W("0006", "The resource template xml \"{0}\" has been deleted, using previous ResourceTemplate. Create new resource template file \"{0}\" inside directory: {1}.", MessageLevel.WARNING),
	...
	JEMR007E("0007", "Error building: {0}. {1} is null. It is mandatory.", MessageLevel.ERROR),
	...
	JEMR008E("0008", "Type of field not found: {0}.", MessageLevel.ERROR),
	...
	JEMR009E("0009", "List field must have at least one value!", MessageLevel.ERROR),
	...
	JEMR010E("0010", "In a SingleSelectableListFieldTemplate the default value \"{0}\" must be contained inside the list of values.", MessageLevel.ERROR),
	...
	JEMR011E("0011", "Configured resource definition \"{0}\" is not an instance of ResourceDefinition", MessageLevel.ERROR),
	...
	JEMR012E("0012", "Impossible to add Configured resource definition: \"{0}\" is null.", MessageLevel.ERROR),
	...
	JEMR013E("0013", "Impossible to get Configured resource definition: \"{0}\" is null.", MessageLevel.ERROR),
	...
	JEMR014E("0014", "Resource type \"{0}\" not found inside the Configured resource definitions.", MessageLevel.ERROR),
	...
	JEMR015E("0015", "Unable to load class \"{0}\"", MessageLevel.ERROR),

	/**
	 * "ResourceDefinition \"{0}\" of type \"{1}\" loaded", MessageLevel.INFO
	 */
	@Description(explanation = "Display the ResourceDefinition loaded.")
	JEMR016I("0016", "ResourceDefinition \"{0}\" of type \"{1}\" loaded", MessageLevel.INFO),
	...
	JEMR017E("0017", "No resource template is configured for Resource\"{0}\". Add template in configuration.", MessageLevel.ERROR),
	...
	JEMR018E("0018", "Impossible to find Configured resource definition: \"{0}\" is null.", MessageLevel.ERROR),
	...
	JEMR019W("0019", "Removed resource \"{0}\" of type \"{1}\": type no longer exists!", MessageLevel.WARNING),
	...
	JEMR020I("0020", "Loaded ResourceDescriptor from \"{0}\".", MessageLevel.INFO),
	...
	JEMR021I("0021", "Loading ResourceDescriptor for resource type \"{0}\" from \"{1}\".", MessageLevel.INFO),
	...
	JEMR022E("0022", "List Field must be the only one field in a section!", MessageLevel.ERROR),
	...
	JEMR023E("0023", "Found duplicate resource with type \"{0}\". Check the configuration.", MessageLevel.ERROR),
	...
	JEMR024W("0024", "Changing a resource definition type from \"{0}\" to \"{1}\", it was not possible to clean the resources of the old type!", MessageLevel.WARNING),
	...
	JEMR025I("0025", "Changed the resource definition type from \"{0}\" to \"{1}\".", MessageLevel.INFO),
	...
	JEMR026I("0026", "Deleted all resources of type: \"{0}\".", MessageLevel.INFO),
	...
	JEMR027W("0027", "Mode \"{0}\" is not valid. A classpath mode is used", MessageLevel.WARNING),
	...
	JEMR028E("0028", "Unable to get registry from {0}:{1}", MessageLevel.ERROR);
	 ...
	 * @see Message
	 */
	private ResourceMessage(String code, String messageContent, MessageLevel level){
