...
public class JmsFactory implements ObjectFactory {
	...
	public Object getObjectInstance(Object obj, Name name, Context nameCtx, Hashtable<?, ?> environment) throws JNDIException {
		...
		try {
			...
			String providerUrl = getReferencePropertyValue(ref, JmsResource.PROVIDER_URL, true);
			String initialContextFactor = getReferencePropertyValue(ref, JmsResource.INITIAL_CONTEXT_FACTORY, true);
			String principal = getReferencePropertyValue(ref, JmsResource.USERID, false);
			String credentials = getReferencePropertyValue(ref, JmsResource.PASSWORD, false);
