...
/**
 * Executor which saves JEM environment configuration file
 * 
 * @author Andrea "Stock" Stocchero
 * @version 1.4	
 *
 */
public class SaveJemEnvConfiguration extends SaveXmlConfigurationFile {
	 ...
	 */
	public SaveJemEnvConfiguration(ConfigurationFile configFile) {
		super(configFile);
	}
	...
	public String getSystemProperty() {
		return ConfigKeys.JEM_ENV_CONF;
	}
}