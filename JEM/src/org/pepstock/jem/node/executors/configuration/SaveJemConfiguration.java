...
/**
 * Executor which saves JEM node configuration file   
 * 
 * @author Andrea "Stock" Stocchero
 * @version 1.4
 *
 */
public class SaveJemConfiguration extends SaveXmlConfigurationFile {
	 ...
	 */
	public SaveJemConfiguration(ConfigurationFile configFile) {
		super(configFile);
	}
