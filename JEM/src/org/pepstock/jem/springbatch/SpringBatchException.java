...
/**
 * Specific Exception for Spring batch customization
 * @author Andrea "Stock" Stocchero
 * @version 1.4
 */
public class SpringBatchException extends MessageException {
	 ...
	 */
	public SpringBatchException(MessageInterface messageInterface) {
	 ...
	 */
	public SpringBatchException(MessageInterface messageInterface, Object... objects) {
	 ...
	 * @param objects data to fill message
	 */
	public SpringBatchException(MessageInterface messageInterface, Throwable cause, Object... objects) {
