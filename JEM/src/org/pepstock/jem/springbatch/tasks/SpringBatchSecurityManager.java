 ...
 * 
 */
class SpringBatchSecurityManager extends BatchSecurityManager {
	 ...
	 * 
	 * @param roles list of roles of job user
	 */
	...
	public void checkExit(int status) {
		// Is not possible to call System.exit
		// ONLY if is internal action
		if (!isInternalAction()){
