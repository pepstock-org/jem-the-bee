...
/**
 * Specific Exception for Spring batch customization, to interrupt the execution without declared exception.
 * @author Andrea "Stock" Stocchero
 * @version 1.4
 */
public class SpringBatchRuntimeException extends MessageRuntimeException {
	 ...
	 */
	public SpringBatchRuntimeException(MessageInterface messageInterface) {
	 ...
	 */
	public SpringBatchRuntimeException(MessageInterface messageInterface, Object... objects) {
	 ...
	 * @param objects data to fill message
	 */
	public SpringBatchRuntimeException(MessageInterface messageInterface, Throwable cause, Object... objects) {
