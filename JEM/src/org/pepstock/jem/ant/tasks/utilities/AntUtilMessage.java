...
public enum AntUtilMessage implements MessageInterface{
	...
	JEMZ001I("0001", "{0} on \"{1}\" is ended. Complete file: {2}", MessageLevel.INFO),
	...
	JEMZ002W("0002", "File \"{0}\" is not deleted", MessageLevel.WARNING),
	...
	JEMZ003I("0003", "File \"{0}\" is deleted", MessageLevel.INFO),
	...
	JEMZ004E("0004", "\"{0}\" command syntax error in command \"{1}\" ", MessageLevel.ERROR),
	...
	JEMZ005I("0005", "Generation \"{0}\" is created", MessageLevel.INFO),
	...
	JEMZ006I("0006", "Generation key \"{0}\" is removed", MessageLevel.INFO),
	...
	JEMZ007I("0007", "File \"{0}\" with key \"{1}\" is added", MessageLevel.INFO),
	...
	JEMZ008I("0008", "GDG \"{0}\" has got generation zero to \"{1}\"", MessageLevel.INFO),
	...
	JEMZ009I("0009", "Resource \"{0}\" XML definition is created", MessageLevel.INFO),
	...
	JEMZ010E("0010", "Data description name \"{0}\" is not a OutputStream instance but \"{1}\"", MessageLevel.ERROR),
	...
	JEMZ011E("0011", "Data description name \"{0}\" is not a InputStream instance but \"{1}\"", MessageLevel.ERROR),
	...
	JEMZ012I("0012", "\"{0}\" resources XML definitions are created", MessageLevel.INFO),
	...
	JEMZ021E("0021", "Manage "+Permissions.STAR+" permission is not allowed", MessageLevel.ERROR),
	...
	JEMZ022I("0022", "Permission \"{0}\" granted to role \"{1}\"", MessageLevel.INFO),

	/**
	 *"Role \"{0}\" is removed", MessageLevel.INFO
	 */
	@Description(explanation = "It informs that role is removed.")
	JEMZ023I("0023", "Role \"{0}\" is removed", MessageLevel.INFO),
	...
	JEMZ024I("0024", "Permission \"{0}\" revoked from role \"{1}\"", MessageLevel.INFO),
	
	/**
	 *"Parsing command \"{0}\" ", MessageLevel.INFO
	 */
	@Description(explanation = "It informs that is parsing the indicated command line.")
	JEMZ025I("0025", "Parsing command \"{0}\" ", MessageLevel.INFO),
	...
	JEMZ026E("0026", "\"{0}\" command is unknown: \"{1}\" ", MessageLevel.ERROR),
	...
	JEMZ027E("0027", "DATE and DAYS arguments are missing either", MessageLevel.ERROR),
	...
	JEMZ028E("0028", "Class \"{0}\" is not an instance of \"{1}\", but \"{2}\"", MessageLevel.ERROR),
	...
	JEMZ029I("0029", "Date is set to \"{0}\" and TransformAndLoader is set to \"{1}\" ", MessageLevel.INFO),	
	...
	JEMZ030W("0030", "TransformAndLoader \"{0}\" throws an excpetion parsing record {1} : {2} ", MessageLevel.WARNING),	
	...
	JEMZ031W("0031", "The sample at record \"{0}\" is not XML well-formed : {1} ", MessageLevel.WARNING),	
	...
	JEMZ032W("0032", "TransformAndLoader \"{0}\" skips file \"{1}\" ", MessageLevel.WARNING),	
	...
	JEMZ033E("0033", "Statistics folder \"{0}\" doesn't exist", MessageLevel.ERROR),
	
	/**
	 *"Collected and managed \"{0}\" files", MessageLevel.INFO
	 */
	@Description(explanation = "It shows how many files have been managed by task.")
	JEMZ034I("0034", "Collected and managed \"{0}\" files", MessageLevel.INFO),
	...
	JEMZ035E("0035", "Property \"{0}\" hasn't got any 'hash' attribute", MessageLevel.ERROR),
	...
	JEMZ036E("0036", "Property \"{0}\" hasn't got any value", MessageLevel.ERROR),
	...
	JEMZ037E("0037", "Permission \"{0}\" is not defined", MessageLevel.ERROR),
	...
	JEMZ038E("0038", "Attribute  \"license\" is missing", MessageLevel.ERROR),
	...
	JEMZ039E("0039", "License file  \"{0}\" does not exist", MessageLevel.ERROR),
	...
	JEMZ040E("0040", "Unable to create \"{0}\" generation druing rebuild by root phase", MessageLevel.ERROR),
	
	/**
	 * "Current GDG root content: {0}", MessageLevel.INFO);
	 */
	@Description(explanation = "It occurs after GDG clean up.")
	JEMZ041I("0041", "Current GDG root content: {0}", MessageLevel.INFO),
	...
	JEMZ042E("0042", "Class \"{0}\" is not an instance of \"{1}\", but \"{2}\"", MessageLevel.ERROR),
	...
	JEMZ043I("0043", "Job Output Archive is set to \"{0}\" ", MessageLevel.INFO),
	...
	JEMZ044E("0044", "Unable to remove job \"{0}\" from output queue", MessageLevel.ERROR),
	...
	JEMZ045W("0045", "Job \"{0}\" is not removed by JobOutputArchive decision", MessageLevel.WARNING),
	...
	JEMZ046E("0046", "JobOutputArchive invocation error with job \"{0}\" ", MessageLevel.ERROR),
	
	/**
	 *"Job \"{0}\" has been archived", MessageLevel.INFO
	 */
	@Description(explanation = "It informs about job has been correctly archived.")
	JEMZ047I("0047", "Job \"{0}\" has been archived", MessageLevel.INFO),
	...
	JEMZ048I("0048", "{0} jobs has been archived on {1}", MessageLevel.INFO),
	...
	JEMZ049E("0049", "Invalid parameter {0}: is not a valid generation", MessageLevel.ERROR),
	...
	JEMZ050E("0050", "Invalid parameter {0}: does not exist", MessageLevel.ERROR),
	
	/**
	 *"File \"{0}\" is renamed in \"{0}\"", MessageLevel.INFO
	 */
	@Description(explanation = "It occurs when a rename of GDG generation ends correctly.")
	JEMZ051I("0051", "File \"{0}\" is renamed in \"{0}\"", MessageLevel.INFO),
	...
	JEMZ052E("0052", "File \"{0}\" is not renamed", MessageLevel.ERROR),
	...
	JEMZ053I("0053", "{0} node(s) drained", MessageLevel.INFO),
	...
	JEMZ054I("0054", "{0} node(s) started", MessageLevel.INFO),
	...
	JEMZ055I("0055", "Certificate with alias \"{0}\" is added", MessageLevel.INFO),
	...
	JEMZ056I("0056", "Certificate with alias \"{0}\" is removed", MessageLevel.INFO),
	...
	JEMZ057W("0057", "Statistics manager is disabled", MessageLevel.WARNING);
	 ...
	 * @see Message
	 */
	private AntUtilMessage(String code, String messageContent, MessageLevel level){
