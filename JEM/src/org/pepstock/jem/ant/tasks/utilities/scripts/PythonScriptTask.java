...
/**
 * Shell script task, which uses PYTHON shell to execute the content of ANT task element
 * 
 * @author Andrea "Stock" Stocchero
 * @version 1.0	
 *
 */
public class PythonScriptTask extends ScriptLanguageTask {
	
	private static final String SHELL = "python";
