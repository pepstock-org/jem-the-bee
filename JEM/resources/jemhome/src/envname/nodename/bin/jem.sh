...
# Application
APP_NAME="JEM-#[jem.environment.name]-#[jem.node.name]"
APP_LONG_NAME="JEM the BEE Node #[jem.node.name] for Environment #[jem.environment.name]"

# Wrapper
WRAPPER_CMD="./wrapper"
WRAPPER_CONF="../config/node_wrapper.conf"
